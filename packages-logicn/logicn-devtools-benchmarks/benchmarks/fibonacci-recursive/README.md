...
LogicN governed flows are expensive to call (each call allocates tagged value objects), so this benchmark isolates that cost.
...
LogicN: fib(20) to keep wall time reasonable; runner normalises throughput.
