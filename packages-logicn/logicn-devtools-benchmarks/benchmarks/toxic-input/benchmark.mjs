import { runLogicNBenchmark } from "../../src/logicn-runner.mjs";
...
export async function runDiagnostic() {
  ...
  for (let i = 0; i < 100; i++) {
    await runLogicNBenchmark("benchmarks/toxic-input/benchmark.lln", "processPayment", [-1, "USD"]);
  }
  ...
  for (let i = 0; i < 100; i++) {
    await runLogicNBenchmark("benchmarks/toxic-input/benchmark.lln", "processPaymentValid", [500, "USD"]);
  }
