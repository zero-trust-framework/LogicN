...
This package (`@logicn/core-sentinel-memory`) is intentionally pure TypeScript over
...
Deeper wiring of LSM into `logicn-tower-citizen`'s `TPLSimulator` (so ternary
