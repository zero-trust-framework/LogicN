// =============================================================================
// logicn-devtools-intelligence — Integration tests
//
// Uses node:test + assert.
// Requires:
//   - The package to be built (npm run build)
//   - Auth-service examples at C:\wwwprojects\LogicN\examples\auth-service\
// =============================================================================
...
// PKG_DIR = .../LogicN/packages-logicn/logicn-devtools-intelligence
// LOGICN_ROOT = .../LogicN
const LOGICN_ROOT = resolve(PKG_DIR, "../..");
const AUTH_SERVICE_DIR = join(LOGICN_ROOT, "examples", "auth-service");
