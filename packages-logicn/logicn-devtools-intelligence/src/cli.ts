#!/usr/bin/env node
// =============================================================================
// logicn-devtools-intelligence — CLI
//
// Usage:
...
function usage(): void {
  console.log(`
logicn-intelligence — Hybrid BM25 + structural code search for LogicN workspaces

COMMANDS
  index <directory>
      Walk all .lln files in <directory>, build/update workspace.lindex.
...
async function cmdSearch(
  ...
  if (flows.length === 0) {
    console.error(`No index found at ${dir}. Run: logicn-intelligence index <directory>`);
    process.exit(1);
  }
