// =============================================================================
// logicn-devtools-intelligence — AST Metadata Extractor
//
...
import { type AstNode, type FlowMeta, type ParseResult } from "@logicn/core-compiler";
...
function deriveGovernanceCodes(meta: FlowMeta, flowNode: AstNode | undefined): string[] {
  ...
  // LLN-GOV-002: MISSING_AUDIT_FOR_GOVERNED_SINK (heuristic)
