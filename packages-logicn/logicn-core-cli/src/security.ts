// CLI output redaction — fail-closed tripwire (R&D 0094-redact PART-A, LLN-CLI-REDACT-001).
//
...
// boundary already leaked it. The checked API reports that bypass (LLN-CLI-REDACT-001) so a caller
...
export const LLN_CLI_REDACT_001 = "LLN-CLI-REDACT-001";
 ...
 * fail closed when a raw credential token slipped past an upstream boundary (LLN-CLI-REDACT-001).
 */
