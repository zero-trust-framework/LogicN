#!/usr/bin/env node
// =============================================================================
// cli.ts — entry point for the LogicN KB Graph scanner
//
// Usage:
...
// Resolve project root: cli.ts is at packages-logicn/logicn-devtools-kb-graph/dist/cli.js
...
async function main(): Promise<void> {
  ...
  // ── Print summary ──────────────────────────────────────────────────────────
  console.log("LogicN KB Graph — docs/Knowledge-Bases/");
  ...
  console.log(`LLN codes: ${stats.totalLlnCodes} unique`);
