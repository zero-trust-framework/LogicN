// @logicn/substrate-math — golden-value oracle for the shared NMR calculus.
// These are the SAME hand-verified constants asserted by the two consumers
// (logicn-tower-citizen/tests/substrate-model.test.mjs and
//  logicn-core-compiler/tests/substrate-contracts.test.mjs). With the math now living
