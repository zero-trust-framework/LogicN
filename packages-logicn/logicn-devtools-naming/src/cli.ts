#!/usr/bin/env node
// =============================================================================
// @logicn/devtools-naming — CLI
//
// logicn-naming check <file.lln> [--json] [--strict]
//
// Exit codes:
//   0 — clean (no findings)
//   1 — usage error
...
async function main(): Promise<number> {
  switch (command) {
    case "check": {
      ...
      if (!filePath) {
        process.stderr.write(
          "Usage: logicn-naming check <file.lln> [--json] [--strict]\n",
        );
        return 1;
      }
    ...
    default:
      process.stdout.write("logicn-naming — LogicN Naming Devtools\n\n");
      process.stdout.write("Commands:\n");
      process.stdout.write(
        "  check <file.lln> [--json] [--strict]   Check naming conventions\n\n",
      );
      process.stdout.write(
