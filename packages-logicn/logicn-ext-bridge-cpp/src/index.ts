/**
 * @logicn/ext-bridge-cpp — native CPU/GPU execution bridges for the Tower
 *
 * The first real implementations of the InferenceBridge contract defined in
 * @logicn/tower-citizen. Brings BitNet ternary kernels (MIT, C:\wwwprojects\BitNet)
 ...
 *
 *   import { createHybridEngine } from "@logicn/tower-citizen";
 *   import { createCppBridgeRegistry } from "@logicn/ext-bridge-cpp";
