// =============================================================================
// LogicN — ext-proof-snarkjs — Main facade
//
// Exports:
//   LogicNSnarkjsProver  — ProverBackend implementation (Phase 1: sha256 seal)
...
//
// Usage:
//   import { createSnarkjsProver } from "@logicn/ext-proof-snarkjs";
...
/**
 * LogicNSnarkjsProver — the Phase 1 snarkjs prover backend for LogicN.
 *
 ...
 * The circuitId will change to "logicn-groth16-bn128-v1.0".
 */
export class LogicNSnarkjsProver implements ProverBackend {
...
export function createSnarkjsProver(): ProverBackend {
  return new LogicNSnarkjsProver();
}
