// =============================================================================
// @logicn/devtools-context — Receipt Generator
//
...
/**
 * Generate Context Receipts for all flows in a .lln source file.
 *
 * Receipts omit the function body, preserving only:
 *   - signature, contract metadata, governance summary, call structure
 *
 * @param source  - LogicN source text (.lln file content)
...
export function generateReceipts(
  ...
  const fileName = options.fileName ?? "source.lln";
  ...
  return {
    schemaVersion: "lln.context-receipt.v1",
    sourceFile: fileName,
