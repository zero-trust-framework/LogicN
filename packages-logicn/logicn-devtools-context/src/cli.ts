...
//
// logicn-context receipt <file.lln> [--flow <flowName>] [--json] [--markdown] [--summary]
//
  ...
  switch (command) {
    case "receipt": {
      ...
      if (!filePath) {
        process.stderr.write(
          "Usage: logicn-context receipt <file.lln> [--flow <flowName>] [--json] [--markdown] [--summary]\n",
        );
        return 1;
      }
    ...
    default: {
      ...
      process.stdout.write(
        `  receipt <file.lln> [--flow <name>] [--json] [--markdown] [--summary]   Generate context receipt(s)\n\n`,
      );
