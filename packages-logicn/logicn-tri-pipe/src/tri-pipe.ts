...
//   • @logicn/ext-photonic-emulator — the physics-faithful photonic backend + 0053 router (AXIS-2)
...
import { createHybridEngine, type HybridInferenceEngine, type PhotonicConfig, type PhotonicKernelCost } from "../../logicn-tower-citizen/dist/index.js";
...
import type { BridgeRegistry, BridgeOp } from "../../logicn-inference-bridge-contract/dist/index.js";
