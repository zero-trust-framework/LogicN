...
LogicN uses a hybrid ownership model. This is the current v1 candidate memory
...
```text
LogicN will not describe itself as memory safe unless the checked/compiler path can
