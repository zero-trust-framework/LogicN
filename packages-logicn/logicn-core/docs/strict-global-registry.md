# LogicN Strict Global Registry

This document describes the proposed Strict Global Registry feature for LogicN /
LogicN.
...
Project-wide values should be declared in `boot.lln`.
...
In Run Mode, LogicN should load and validate registry values before execution.

In Compile Mode, LogicN should validate the registry and include it in reports,
