...
This document tracks practical tasks for **LogicN / LogicN**.
...
[ ] Write grammar draft
[/] Draft README
[x] Choose .lln extension
[?] Decide boot.lln vs main.lln
...
```text
[x] Project name: LogicN / LogicN
[x] Source file extension: .lln
...
[x] Separate LogicN core language concerns from the optional Secure App Kernel layer
[x] Support simple `console.log("...")` output in checked Run Mode
[x] Document package boundaries from `logicn-core` to `logicn-core-logic`, `logicn-core-vector`,
    `logicn-core-compute`, `logicn-core-photonic`, target packages, CLI and task packages
...
```text
[?] Should the main entry file be boot.lln or main.lln?
[?] Should boot.lln contain both project config and executable logic?
[?] Should LogicN.config be required or optional?
[?] Should LogicN use braces only, indentation only, or braces with optional formatting?
...
```text
Tri / LogicN / Omni work should update packages-logicn/logicn-core-logic first.
Vector work should update packages-logicn/logicn-core-vector first.
Compute planning work should update packages-logicn/logicn-core-compute first.
...
Compiler pipeline work should update packages-logicn/logicn-core-compiler first.
Runtime execution work should update packages-logicn/logicn-core-runtime first.
Security primitive work should update packages-logicn/logicn-core-security first.
Config and report shape work should update packages-logicn/logicn-core-config or
packages-logicn/logicn-core-reports first.
logicn-core should be updated when syntax, compiler validation or report contracts
change.
```

## Moved to Package TODOs

These areas are intentionally tracked outside `logicn-core` first:

```text
Tri, LogicN, Decision and Omni semantics -> packages-logicn/logicn-core-logic/TODO.md
Vector values, lanes and operation semantics -> packages-logicn/logicn-core-vector/TODO.md
Compute planning and target selection -> packages-logicn/logicn-core-compute/TODO.md
AI inference contracts -> packages-logicn/logicn-ai/TODO.md
Low-bit AI backend -> packages-logicn/logicn-ai-lowbit/TODO.md
...
Compiler pipeline implementation -> packages-logicn/logicn-core-compiler/TODO.md
Runtime execution contracts -> packages-logicn/logicn-core-runtime/TODO.md
Security primitives and report contracts -> packages-logicn/logicn-core-security/TODO.md
Config loading contracts -> packages-logicn/logicn-core-config/TODO.md
Shared report schemas -> packages-logicn/logicn-core-reports/TODO.md
CLI command UX and dispatch -> packages-logicn/logicn-core-cli/TODO.md
Safe task automation -> packages-logicn/logicn-core-tasks/TODO.md
API transport -> packages-logicn/logicn-framework-api-server/TODO.md
Application boundary enforcement -> packages-logicn/logicn-framework-app-kernel/TODO.md
```
...
[ ] Create docs/ternary-logic.md as syntax/report reference to logicn-core-logic
...
[ ] Add note that compiled LogicN apps can use their own licence
[ ] Add note that LogicN name/logo should not imply endorsement for forks
...
```text
[ ] Explain what LogicN app source files should be committed
...
[ ] Define LogicN init
[x] Define LogicN run
[x] Define LogicN serve --dev planning report
[ ] Define LogicN build
[ ] Define LogicN check
[x] Define LogicN test
[x] Define LogicN fmt
[ ] Define LogicN lint
[ ] Define LogicN explain
[ ] Define LogicN explain --for-ai
[x] Define LogicN verify
[x] Define LogicN targets
[x] Define LogicN ai-context
[x] Define LogicN schema
...
[x] Define LogicN ai-context output
[x] Define LogicN explain --for-ai output
...
[ ] Map generated output to original .lln files
...
[ ] Add source-map lookup to LogicN explain
[ ] Add source-map lookup to LogicN explain --for-ai
```
...
[ ] Decide boot.lln vs main.lln default
[ ] Draft grammar outline
[ ] Draft example boot.lln
[ ] Draft example hello.lln
...
make LogicN easier for AI tools to understand
