...
//   3. GOVERNED   — same, but the bridge registry comes from logicn-ext-bridge-cpp
...
try {
  ({ createCppBridgeRegistry } = await import("@logicn/ext-bridge-cpp"));
} catch {
  try { ({ createCppBridgeRegistry } = await import("../../logicn-ext-bridge-cpp/dist/index.js")); }
