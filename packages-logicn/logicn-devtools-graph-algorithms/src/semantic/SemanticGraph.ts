...
// Design: logicn-phase-13-decisions.md Decision 1
// Spec:   logicn-semantic-graph-system.md
//
// Location: logicn-devtools-graph-algorithms (monorepo-first)
// Future:   extract to C:\laragon\www\LLN-Graph once API stabilises
// =============================================================================
...
export interface SemanticGraph {
  ...
  readonly sourceFile?: string;    // primary .lln file
