// =============================================================================
// Stage B Report — LogicN self-hosting milestone tracker
//
// Tracks the four Stage B milestone files:
//   1. lexer.lln
//   2. parser.lln
//   3. type-checker.lln
//   4. compiler.capabilities.lln
//
...
const STAGE_B_MILESTONE_FILES: readonly { readonly name: string; readonly file: string }[] = [
  { name: "lexer",                file: "lexer.lln"                  },
  { name: "parser",               file: "parser.lln"                 },
  { name: "type-checker",         file: "type-checker.lln"           },
  { name: "compiler.capabilities",file: "compiler.capabilities.lln"  },
] as const;
