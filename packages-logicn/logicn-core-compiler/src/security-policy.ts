// =============================================================================
// LogicN — Security Policy Constants and Anti-Abuse Architecture
//
...
//   LLN-NET-001/002 (destination denied, SSRF/private-range access)
//
...
// ---------------------------------------------------------------------------
// LLN-NET-001: Network destination not in declared allowlist
// ---------------------------------------------------------------------------

/**
 * LLN-NET-001: A network call was made to a host not in the flow's declared
...
// ---------------------------------------------------------------------------
// LLN-NET-002: Network call resolved to a private/reserved IP range (SSRF)
// ---------------------------------------------------------------------------

/**
 * LLN-NET-002: A network call resolved to a private or reserved IP address.
 *
...
// ---------------------------------------------------------------------------
// LLN-RUNTIME-006: Rate limit exceeded at runtime
// ---------------------------------------------------------------------------

/**
 * LLN-RUNTIME-006: A declared contract limit was exceeded during execution.
 *
