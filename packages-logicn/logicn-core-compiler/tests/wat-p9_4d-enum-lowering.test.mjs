...
describe("#144 enum-variant lowering", () => {
  it("buildEnumVariants reads declaration order", () => {
    const prog = parseProgram(ENUM_SRC, "t.lln");
  ...
  it("the self-hosted lexer has ZERO unresolved-member placeholders", async () => {
    ...
    // sanity: TokenKind.Eof is variant index 11 in lexer.lln
    const enums = buildEnumVariants(parseProgram(src, "lexer.lln").ast);
