/**
 * Self-hosted GIR emitter (gir-emitter.lln) — execution tests.
 *
 * Exercises the Stage B GIR emitter by executing the .lln flows through the
...
describe("gir-emitter.lln — parses clean", () => {
...
describe("gir-emitter.lln — expression GIR ops", () => {
...
describe("gir-emitter.lln — flow-decl GIR node", () => {
...
describe("gir-emitter.lln — module emission", () => {
