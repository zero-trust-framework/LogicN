/**
 * Self-hosted parser — grammar extensions (parser.lln).
 *
 * Logical and/or (lowest precedence), unary prefix (! → "not", - → "neg"),
 * and if/else branches. Tokenizes real source with lexer.lln, parses a flow
...
describe("parser.lln grammar — logical and/or", () => {
...
describe("parser.lln grammar — unary prefix", () => {
...
describe("parser.lln grammar — if/else", () => {
