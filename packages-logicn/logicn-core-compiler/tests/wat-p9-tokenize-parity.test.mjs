/**
 * P9 #143 — BYTE-PARITY: the self-hosted `lexer.lln` tokenize produces an IDENTICAL
 ...
 *
 * The WASM path goes .lln → WAT → real-wabt module → Ed25519-attested #105 admission →
...
let SRC = readFileSync(join(__dir, "../src/self-hosted/lexer.lln"), "utf8");
if (SRC.charCodeAt(0) === 0xFEFF) SRC = SRC.slice(1);
const prog = L.parseProgram(SRC, "lexer.lln");
