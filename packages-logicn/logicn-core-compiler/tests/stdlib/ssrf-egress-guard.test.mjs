...
// It now delegates to the hardened @logicn/core-network guardOutboundUrl, which
...
// result is a LogicN Err carrying the SSRF / LLN-NET-001 marker.
// =============================================================================
...
function assertSsrfDenied(result, label) {
  ...
  assert.match(msg, /LLN-NET-001/, `${label}: Err must carry LLN-NET-001 — got: ${msg}`);
}
