/**
 * Self-hosted runtime dispatcher (runtime.lln) — execution tests.
 *
 * Exercises the Stage B tier-selection logic by executing the .lln flows
...
const RUNTIME_LLN = join(__dir, "..", "src", "self-hosted", "runtime.lln");

const program = parseProgram(readFileSync(RUNTIME_LLN, "utf8"), "runtime.lln");
...
describe("runtime.lln — parses clean", () => {
...
describe("runtime.lln — selectTier", () => {
...
describe("runtime.lln — isCacheEligible", () => {
...
describe("runtime.lln — buildExecutionPlan (cache regression guard)", () => {
...
describe("runtime.lln — GIR evaluator (S7)", () => {
...
describe("runtime.lln — runProgram (cross-flow call)", () => {
