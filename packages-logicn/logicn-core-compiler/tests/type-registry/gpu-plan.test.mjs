...
describe("buildWebGPUPlan: schema and structure", () => {
  it("returns a plan with schemaVersion lln.gpu.v1", () => {
    const plan = buildWebGPUPlan("scoreFlow", []);
    assert.equal(plan.schemaVersion, "lln.gpu.v1");
...
describe("buildNPUPlan: schema and structure", () => {
  it("returns a plan with schemaVersion lln.npu.v1", () => {
    const plan = buildNPUPlan("inferFlow", []);
    assert.equal(plan.schemaVersion, "lln.npu.v1");
...
describe("buildAPUSharedMemoryPlan: schema and structure", () => {
  it("returns a plan with schemaVersion lln.apu.v1", () => {
    const plan = buildAPUSharedMemoryPlan("flow", []);
    assert.equal(plan.schemaVersion, "lln.apu.v1");
  });
