// =============================================================================
// @logicn/devtools-security — Security Test Helpers
//
// Utilities for writing security tests in LogicN projects.
// Import in your test files to get fluent security assertion APIs.
//
// Usage:
//   import { SecurityTestHelper } from "@logicn/devtools-security";
//   const s = new SecurityTestHelper();
//   await s.assertBlocked(source, "LLN-TAINT-001");
