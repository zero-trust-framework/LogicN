...
[ ] Define RuntimeAuditEvent v0.2: schemaVersion "logicn.runtime.audit.v1", eventId, timestamp, category (8 values), status, message, runtime, effect?, capability?, destination?, references?, metadata?
...
[ ] Define ExecutionProof v0.2: schemaVersion "logicn.proof.v1", proofId, generatedAt, hashes: ExecutionProofHashes
