// =============================================================================
// @logicn/devtools-pci — Black Box Compliance Ledger (#146)
//
// Consumes the audit-egress ledger produced by @logicn/core-sentinel-egress
...
//
// Schema version: lln.compliance-ledger.v1
// =============================================================================
...
// ---------------------------------------------------------------------------
// Egress ledger shape (format-compatible with @logicn/core-sentinel-egress)
// ---------------------------------------------------------------------------
 ...
 * Format-compatible with `readEgressLedger` from @logicn/core-sentinel-egress.
 */
...
export interface ComplianceReport {
  readonly schemaVersion: "lln.compliance-ledger.v1";
...
export function buildComplianceReport(
  ...
  return {
    schemaVersion: "lln.compliance-ledger.v1",
    sourceDir,
