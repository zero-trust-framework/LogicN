(module
  ...
  ;; effect: secret.read
  (import "host" "secret.read" (func $host_secret_read (param $p0 i32) (param $p1 i32) (result i32)))
  ;; effect: secret.read
  (import "host" "env.get" (func $host_env_get (param $p0 i32) (param $p1 i32) (result i32)))
  ;; effect: secret.read
  (import "host" "vault.read" (func $host_vault_read (param $p0 i32) (param $p1 i32) (result i32)))

  ;; effectful flow: transferFunds
  (func $transferFunds (param $p0 externref) (result i32)
    unreachable
  )
