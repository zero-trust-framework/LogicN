# LogicN Phase 11B — Two-Hop Taint Propagation
...
New diagnostic: LLN-VALUESTATE-005 (DERIVED_UNSAFE_VALUE_AT_SINK)
```
...
UsersDB.find(rawId)   // LLN-VALUESTATE-003: unsafe at sink ✓
```
...
## New Diagnostic: LLN-VALUESTATE-005
...
### Caught by 11B.1 (LLN-VALUESTATE-005)
...
effects [database.read] {
  ...
  let data = UsersDB.query(cleaned)            // LLN-VALUESTATE-005
  return "ok"
}
```
...
UsersDB.insert(step2)   // LLN-VALUESTATE-005 — taint propagated 2 hops
```
...
|---|---|---|
| LLN-VALUESTATE-003 | Direct unsafe binding at governed sink | Phase 6 ✅ |
| LLN-VALUESTATE-004 | Tainted string concatenation | Phase 6 ✅ |
| LLN-VALUESTATE-005 | Derived/laundered unsafe value at sink | Phase 11B.1 |
...
- `logicn-phase-11-decisions.md` — Phase 11 implementation decisions
