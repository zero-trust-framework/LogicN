...
This single sentence captures the entire LogicN IGO philosophy. Intent declarations
...
**Recommendation:** LogicN quantum support remains **target-bridge based**.
...
- Auto-suggestion of `compute target` blocks when `LLN-HINT-COMPUTE-001` fires
...
- `docs/Knowledge-Bases/logicn-adaptive-runtime-profiles.md` — runtime modes
- `docs/Knowledge-Bases/logicn-architecture-layers.md` — five-layer model
- `docs/Knowledge-Bases/logicn-proof-chain-spec.md` — audit proof chain
- `docs/Knowledge-Bases/logicn-compute-target-optimisation.md` — GIR tensor metadata
- `docs/Knowledge-Bases/logicn-quantum-target-bridge.md` — quantum architecture
