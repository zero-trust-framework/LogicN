...
LogicN source has more metadata than most languages. A single flow may carry:
...
- `logicn explain` (showing developers why a decision was made)
...
This means LogicN can afford to be generous with AI-readable metadata in source:
...
- `logicn-passive-execution-plans.md` — the primary artifact of metadata erasure
- `logicn-static-capability-proofs.md` — what survives from effects into the plan
- `logicn-semantic-graph-system.md` — where rich metadata is retained for tooling
- `logicn-phase-13-decisions.md` — Decision 5 (canonical form hashing for attestation)
...
- `logicn-signed-attestation.md` — signed attestation format
