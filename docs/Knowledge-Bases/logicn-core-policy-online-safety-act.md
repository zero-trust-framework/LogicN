...
This document specifies how LogicN supports Online Safety Act-style rules
by making age assurance a first-class policy primitive.

Applies to: `logicn-core-policy`, `logicn-core-logic`, `logicn-core-network`

See also: `logicn-core-logic-tristate-developer-guide.md`,
`logicn-core-logic-v02.md`, `logicn-api-boundary-architecture.md`.
...
LogicN must not treat age as a normal boolean. Age assurance status is
...
## Alignment with LogicN Systems

| LogicN System | Role in Age Assurance |
| ----------------------------- | --------------------------------- |
