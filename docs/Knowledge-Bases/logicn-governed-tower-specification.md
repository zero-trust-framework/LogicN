...
LogicN is a **High-Assurance Governance-as-Code** platform. It departs from traditional
...
atomic hardware-level traps at runtime, LogicN eliminates the Confused Deputy Problem and
...
**Symbol Resolution Gate (LLN-INV-004):**
...
Instead of complex auto-propagation, LogicN uses **Explicit Assertion Bridging**. The
...
| LLN-INV-001/003/004 diagnostics | 3 | ✅ ENFORCED |
...
| LLN-INV-000 runtime trap handler | 2 | ⬜ Task #76 (Phase 5 gate) |
...
| **Layer 1 — Rules** | `logicn-governance-rules.md` — 37+ LLN codes |
| **Layer 2A — Patterns** | `logicn-architecture-patterns.md` |
| **Layer 2B — Syntax** | `logicn-contract-authoring-guide.md`, `logicn-contract-clause-reference.md` |
| **Layer 3 — Runtime** | `logicn-deterministic-runtime-containment.md` |
| **CBOR** | `logicn-cbor-manifest-spec.md` |
| **Proof-Tracing** | `logicn-proof-tracing-design.md` |
| **Agile Governance** | `logicn-agile-governance-pattern.md` |
| **CI/CD Pipeline** | `logicn-governance-cicd-pipeline.md` |
| **Floor 3 Graph** | `logicn-floor3-proof-zone-graph.md` |
| **Infographic Concept** | `logicn-platform-infographic-concept.md` |
| **Build Roadmap** | `logicn-build-roadmap.md` |
| **Engineering Goals** | `logicn-engineering-goals.md` (Goals A/B/C, T-006/007/008) |
