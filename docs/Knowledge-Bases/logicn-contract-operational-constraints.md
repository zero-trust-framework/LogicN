...
Parser: Phase 10B
Enforcement: LLN-TIMEOUT-001, LLN-RETRY-001, LLN-LIMIT-001 (Phase 10C+)
```
...
- `deadline unlimited` is not valid in LogicN — unbounded execution must be justified by a policy declaration
...
- `docs/Knowledge-Bases/logicn-governed-memory-blocks.md` — memory governance
- `docs/Knowledge-Bases/logicn-contract-privacy-observability.md` — privacy and observability sections
