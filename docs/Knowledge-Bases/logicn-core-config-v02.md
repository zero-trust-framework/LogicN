...
This document is the v0.2 canonical specification for `logicn-core-config`.

See also: `logicn-core-config-environment-secrets.md` (prior KB).
...
The class form with `reveal()` is in `logicn-core-security`.
