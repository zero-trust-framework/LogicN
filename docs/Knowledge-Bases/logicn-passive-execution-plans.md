...
## The LogicN Alternative

LogicN separates two fundamentally different kinds of work:
...
See `logicn-static-capability-proofs.md` for the full proof model.
...
See `logicn-metadata-erasure.md` for the full erasure model.
...
Phase 13 moves LogicN from interpreter-driven to plan-driven execution:
...
- `logicn-static-capability-proofs.md` — capability proofs that feed approved_capabilities
- `logicn-metadata-erasure.md` — what is erased to produce the plan
- `logicn-semantic-graph-system.md` — rich metadata model (upstream of the plan)
- `logicn-gir-schema.md` — Governed IR (immediate upstream of plan generation)
- `logicn-phase-13-decisions.md` — Decision 3 (compiler graph), Decision 5 (canonical hashing)
- `logicn-concept-governed-execution-plan.md` — governed execution plan concept
- `logicn-proof-chain-spec.md` — attestation chain spec
- `logicn-runtime-lifecycle.md` — runtime startup and plan loading
