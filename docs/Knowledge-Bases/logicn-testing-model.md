...
Core principle: LogicN tests prove behaviour AND governance
...
LogicN tests prove behaviour plus governance.
```
...
| 4 | Type checker | LLN-TYPE-001..022 | Done |
...
```
LogicN tests prove behaviour, safety, governance, and evidence.
```
