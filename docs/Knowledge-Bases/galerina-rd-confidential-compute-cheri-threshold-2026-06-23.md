...
**House honesty rules inherited:** no "military-grade / impenetrable / physically ceases to exist." Crypto stays **Binary/digital** (FUNGI-SUBSTRATE-001); the in-memory wipe "closes the host-readable remanence window," it is **not** impenetrability. Per the standing posture, **Galerina introduces no new science by design** — confidential computing, CHERI, and Shamir secret-sharing are all ESTABLISHED, so the ceiling is **defensive-pub**.
