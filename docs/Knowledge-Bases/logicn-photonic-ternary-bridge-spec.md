...
Diagnostics:
- `LLN-TYPE-031` InvalidTriCondition
- `LLN-TYPE-032` InvalidTriOperand
- `LLN-TYPE-033` TriBoolImplicitCoercionDenied
...
Diagnostics:
- `LLN-PHOTONIC-001` MissingPhotonicCalibration
- `LLN-PHOTONIC-002` UnsupportedPhotonicOp
- `LLN-PHOTONIC-003` DeterminismRisk
- `LLN-PHOTONIC-004` TrustProfileMismatch
...
- `logicn-core-logic-tri-decision-bool.md` — runtime TriState/Decision logic contracts (logicn-core-logic package)
- `logicn-core-logic-tristate-developer-guide.md` — developer guide for runtime Tri logic patterns
- `logicn-photonic-distinct-compute-model.md` — photonic as a distinct compute substrate (types, IR, wavelength model)
- `logicn-core-photonic-backend-architecture.md` — governance-first photonic runtime architecture
- `logicn-core-photonic-governance-architecture.md` — photonic governance overlay spec
- `logicn-phase13-passive-plans-target-bridges.md` — Phase 13 TargetBridgePlan and HardwareTrustProfile contracts
- `formal-type-system-spec.md` — authoritative type rules and LLN-TYPE-* diagnostics
