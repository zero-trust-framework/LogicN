...
Package: `logicn-framework-api-server`
Depends On: `logicn-framework-app-kernel`, `logicn-core-runtime`,
            `logicn-core-security`, `logicn-core-network`, `logicn-core-reports`
