...
These examples show all major Galerina governance concepts in combination:
...
| Document | Notes |
|---|---|
| [galerina-concept-intent.md](galerina-concept-intent.md) | Full intent specification |
