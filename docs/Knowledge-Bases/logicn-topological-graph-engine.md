...
Wasmtime-only TCB constraint (`PRINCIPLE: No Rust in the project; everything is .lln → WASM`).
...
**What it is:** During the admission gate (`logicn verify`), all `[conforms_to:]` domain
...
| 409 | (Reserved) | — |
| 410 | AuditEvent | LLN-INV-000 runtime governance violation |
...
| Topic | Document |
|---|---|
| V_DPM bit layout | `logicn-governed-tower-specification.md` |
| CBOR tag registry | `logicn-cbor-manifest-spec.md` |
| Domain guard policies | `logicn-domain-guard-policies.md` |
| DSS.wasm scaffolding | `logicn-deterministic-runtime-containment.md` |
| Agile governance patterns | `logicn-agile-governance-pattern.md` |
| Proof-tracing design | `logicn-proof-tracing-design.md` |
