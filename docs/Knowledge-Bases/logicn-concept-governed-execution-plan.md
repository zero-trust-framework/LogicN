...
A mismatch between the two is caught at compile time (`LLN-INTENT-001`).
...
| Document | Notes |
|---|---|
| [Intent](logicn-concept-intent.md) | First pipeline stage — semantic purpose declaration |
| [Coordinated Compute](logicn-concept-coordinated-compute.md) | Third stage — runtime execution against the plan |
| [Audit Proof](logicn-concept-audit-proof.md) | Fourth stage — verifiable execution evidence |
