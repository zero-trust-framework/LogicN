# LogicN — Trust, Sensitivity, and Collection Type Rules
...
unsafe let email: Email = request.body.email    // LLN-TYPE-003

// WRONG — Array<Email> implies validated elements
unsafe let emails: Array<Email> = request.body.emails  // LLN-TYPE-003
...
| `unsafe let email: Email = request.body.email` | ❌ LLN-TYPE-003 | Domain type implies validation |
| `unsafe let emails: Array<Email> = request.body.emails` | ❌ LLN-TYPE-003 | Array<Email> implies validated elements |
| `unsafe let id: CustomerId = request.body.id` | ❌ LLN-TYPE-003 | Brand type implies validation |
...
- `docs/Knowledge-Bases/logicn-type-improvements-phase-8.md` — LLN-TYPE-003
