...
LogicN's governance model is more than a four-stage execution pipeline. It is a
...
- [logicn-intent-graph.md](logicn-intent-graph.md)
...
**Full specification:** [logicn-concept-intent.md](logicn-concept-intent.md)
...
```text
imported package authority    — what does @logicn/payments bring in?
...
**Related:** [logicn-governance-diff-ci.md](logicn-governance-diff-ci.md)
...
LogicN changes this. Instead of giving AI 500,000 lines of source:
...
```text
LLN-RUNTIME-001: Execution violates governed execution plan.
...
LogicN's negative guarantees come from:
...
then gradually becomes stale. LogicN's threat model is derived from the live
...
**Full specification:** [logicn-concept-governed-execution-plan.md](logicn-concept-governed-execution-plan.md)
...
**Full specification:** [logicn-concept-coordinated-compute.md](logicn-concept-coordinated-compute.md)
...
**Full specification:** [logicn-concept-audit-proof.md](logicn-concept-audit-proof.md)
...
| Intent verification (`LLN-INTENT-001..005`) | ✅ Phase 3 scanner-level |
| Authority tracking, capability propagation | ⬜ Phase 5 (type + effect checker) |
| Effect propagation (`LLN-EFFECT-*`) | ⬜ Phase 5 |
...
| Unsafe boundary visibility | ✅ Phase 3 (`LLN-RAWPTR-001`, `LLN-MEMORY-008`) |
