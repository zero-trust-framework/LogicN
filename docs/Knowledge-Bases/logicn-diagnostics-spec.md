...
- **Reuses:** the compiler's existing formal-method machinery (`invariant {}` blocks #36, LLN-INV-000 #76) extended from compile-time to the runtime harness. The ultimate "Janitor" — detects the *potential* for a mess.
