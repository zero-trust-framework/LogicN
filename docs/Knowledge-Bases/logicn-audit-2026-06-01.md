...
| 26B | ImmutableInputSeal, HardwareGovernanceClass, ProofLevel, LLN-HW-001/002/003 | ✅ | +20 |
...
| 29 | @logicn/core-economics — CostGraph, ValueGraph, IBM matrix, RouteDecision | ✅ | +15 |
...
| Hardware diagnostics | `LLN_HW_001/002/003` | ✅ |
| Value/Safety diagnostics | `LLN_VAL_001/002/003` | ✅ |
| ProofGraph caching | `buildProofGraphCached`, `getProofCacheStats` | ✅ |
| Governance diff | `diffGovernance`, `renderGovernanceDiff` | ✅ |
| CostGraph | `@logicn/core-economics` package | ✅ |
...
| LLN-PROFILE codes | 7 (001–007) |
| LLN-TAINT codes | 4 (001–004) |
| LLN-HW codes | 3 (001–003) |
| LLN-VAL codes | 3 (001–003) |
...
Phase 34: `verifyPassword` HTTP service = **Runtime 25%** — the first `.lln` file that IS the service.
