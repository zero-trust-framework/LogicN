...
See also: `logicn-core-security-v02.md` (v0.2 formal spec),
...
specification form of `logicn-core-security`. The v0.2 formal spec KB
(`logicn-core-security-v02.md`) uses different field shapes for several
...
`logicn-core-security` defines reusable security primitives and secret-safe
runtime contracts for the LogicN ecosystem.
...
Note: The v0.2 formal spec (`logicn-core-security-v02.md`) uses a different
...
| Item | This architecture spec | v0.2 formal spec (logicn-core-security-v02.md) |
| ----------------------- | --------------------------------- | --------------------------------------- |
