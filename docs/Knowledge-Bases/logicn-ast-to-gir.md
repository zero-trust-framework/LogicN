...
Schema: docs/Knowledge-Bases/logicn-gir-schema.md
...
`logicn-gir-schema.md`; this document defines extraction and mapping rules.
...
LLN-EFFECT-* error and GIR emission does not run.
```
...
Manifest generation is specified in `logicn-core-manifest-generation-v02.md`.
