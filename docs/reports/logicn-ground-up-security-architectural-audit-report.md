# LogicN: Ground-Up Security & Architectural Audit Report
...
- `build/graph/LogicN_GRAPH_REPORT.md`: generated workspace graph summary.
...
LogicN has a credible governed-runtime prototype: the compiler suite passes, the
...
- 4069 tests total
- `logicn-tower-citizen`: 73 tests
- `logicn-ext-bridge-cpp`: 13 tests
...
- `docs/Knowledge-Bases/logicn-runtime-status-SOT.md:15`
- `docs/Knowledge-Bases/logicn-runtime-status-SOT.md:26`
- `docs/Knowledge-Bases/logicn-runtime-status-SOT.md:36`
...
Evidence:
- `packages-logicn/logicn-tower-citizen/src/hybrid-engine.ts:295`
- `packages-logicn/logicn-tower-citizen/src/hybrid-engine.ts:297`
...
- `examples/foundations/ai-inference-governed.lln:28`
- `examples/foundations/ai-inference-governed.lln:43`
- `examples/foundations/ai-inference-governed.lln:46`
...
- `packages-logicn/logicn-tower-citizen/src/hybrid-engine.ts:55`
- `packages-logicn/logicn-tower-citizen/src/hybrid-engine.ts:389`
...
- add tests for direct engine calls and `logicn infer`
...
- `packages-logicn/logicn-tower-citizen/src/hybrid-engine.ts:312`
- `packages-logicn/logicn-tower-citizen/src/hybrid-engine.ts:331`
...
- `packages-logicn/logicn-tower-citizen/src/bridge/interface.ts:96`
...
The bridge package imports runtime values from `@logicn/tower-citizen`, not only
types. The package graph records `@logicn/ext-bridge-cpp` depending on
`@logicn/tower-citizen`:

- `packages-logicn/logicn-ext-bridge-cpp/.graph/package-graph.json:42`

Source imports include `StubTernaryBridge`, `GovernanceEnforcer`, `AuditLogger`,
and `assertDeterminism`:

- `packages-logicn/logicn-ext-bridge-cpp/src/bitnet-cpu-bridge.ts:20`
...
- `packages-logicn/logicn-tower-citizen/src/tpl-simulator.ts:181`
...
- `packages-logicn/logicn-tower-citizen/src/tpl-simulator.ts:212`
- `packages-logicn/logicn-tower-citizen/src/tpl-simulator.ts:238`
- `packages-logicn/logicn-tower-citizen/src/tpl-simulator.ts:239`

The native bridge defines `canCommit()`, but `execute()` does not call it before
running the reference path or native `tmac()`:

- `packages-logicn/logicn-ext-bridge-cpp/src/bitnet-cpu-bridge.ts:66`
- `packages-logicn/logicn-ext-bridge-cpp/src/bitnet-cpu-bridge.ts:74`
- `packages-logicn/logicn-ext-bridge-cpp/src/bitnet-gpu-bridge.ts:47`
- `packages-logicn/logicn-ext-bridge-cpp/src/bitnet-gpu-bridge.ts:52`
...
- `packages-logicn/logicn-tower-citizen/src/tpl-simulator.ts:60`
- `packages-logicn/logicn-tower-citizen/src/tpl-simulator.ts:74`

The stub bridge decoder maps `0b11` to zero:

- `packages-logicn/logicn-tower-citizen/src/bridge/stub-provider.ts:68`
- `packages-logicn/logicn-tower-citizen/src/bridge/stub-provider.ts:78`
...
`logicn-ext-bridge-cpp` loads a `.node` addon from candidate paths via
`createRequire()` and `existsSync()`:

- `packages-logicn/logicn-ext-bridge-cpp/src/addon-loader.ts:14`
- `packages-logicn/logicn-ext-bridge-cpp/src/addon-loader.ts:19`
- `packages-logicn/logicn-ext-bridge-cpp/src/addon-loader.ts:52`
- `packages-logicn/logicn-ext-bridge-cpp/src/addon-loader.ts:56`
...
- `packages-logicn/logicn-core-sentinel-egress/src/audit-egress.ts:11`
- `packages-logicn/logicn-core-sentinel-egress/src/audit-egress.ts:92`

Sentinel State also defaults to an all-zero development key:

- `packages-logicn/logicn-core-sentinel-state/src/state-serializer.ts:30`
- `packages-logicn/logicn-core-sentinel-state/src/state-serializer.ts:34`
- `packages-logicn/logicn-core-sentinel-state/src/state-serializer.ts:52`
...
- `packages-logicn/logicn-core-sentinel-memory/src/tpl-state-buffer.ts:24`
- `packages-logicn/logicn-core-sentinel-memory/src/tpl-state-buffer.ts:76`

LSIO validates source blocks against SHA-256 manifests:

- `packages-logicn/logicn-core-sentinel-io/src/manifest.ts:153`
- `packages-logicn/logicn-core-sentinel-io/src/zero-copy-mapper.ts:88`

LSS validates snapshots with XOR checksum plus HMAC:

- `packages-logicn/logicn-core-sentinel-state/src/state-serializer.ts:6`
- `packages-logicn/logicn-core-sentinel-state/src/state-serializer.ts:75`
...
- `packages-logicn/logicn-core-sentinel-power/src/power-governor.ts:96`
- `packages-logicn/logicn-core-sentinel-power/src/power-governor.ts:128`

But its own architecture issue file says wiring this into `HybridEngine` bridge
selection is deferred:

- `packages-logicn/logicn-core-sentinel-power/ARCHITECTURE_ISSUES.md:20`
- `packages-logicn/logicn-core-sentinel-power/ARCHITECTURE_ISSUES.md:25`
...
- CLI parses `ai {}` and wires the Tower to the C++ bridge registry.
  Evidence: `logicn.mjs:476`, `logicn.mjs:519`, `logicn.mjs:522`
- `HybridInferenceEngine` performs Load, plan, governance check, dispatch, audit,
  latency check, and erase.
  Evidence: `packages-logicn/logicn-tower-citizen/src/hybrid-engine.ts:232`,
  `packages-logicn/logicn-tower-citizen/src/hybrid-engine.ts:251`,
  `packages-logicn/logicn-tower-citizen/src/hybrid-engine.ts:283`
- `BridgeRegistry` is the Brain/Brawn dispatch seam.
  Evidence: `packages-logicn/logicn-tower-citizen/src/hybrid-engine.ts:312`
- LSIO enforces manifest integrity before releasing mapped blocks.
  Evidence: `packages-logicn/logicn-core-sentinel-io/src/zero-copy-mapper.ts:88`
- LSM provides a fixed-size pool and flight allocation lock.
  Evidence: `packages-logicn/logicn-core-sentinel-memory/src/static-memory-pool.ts:97`,
  `packages-logicn/logicn-core-sentinel-memory/src/static-memory-pool.ts:159`
- LSS verifies snapshots before parsing payload.
  Evidence: `packages-logicn/logicn-core-sentinel-state/src/state-serializer.ts:93`
- LST provides a deterministic logical clock.
  Evidence: `packages-logicn/logicn-core-sentinel-time/src/logical-clock.ts:22`
- Egress batches and HMAC-chains audit records.
  Evidence: `packages-logicn/logicn-core-sentinel-egress/src/audit-egress.ts:121`,
  `packages-logicn/logicn-core-sentinel-egress/src/audit-egress.ts:167`
...
- `docs/Knowledge-Bases/logicn-governed-tower-specification.md:15`
- `docs/Knowledge-Bases/logicn-governed-tower-specification.md:22`
- `docs/Knowledge-Bases/logicn-governed-tower-specification.md:57`
- `docs/Knowledge-Bases/logicn-governed-tower-specification.md:127`

The same document later marks V_DPM and DSS.wasm items as not yet implemented:

- `docs/Knowledge-Bases/logicn-governed-tower-specification.md:229`
- `docs/Knowledge-Bases/logicn-governed-tower-specification.md:230`
...
- `docs/Knowledge-Bases/logicn-governed-inference-tower.md:215`
- `docs/Knowledge-Bases/logicn-governed-inference-tower.md:231`
- `docs/Knowledge-Bases/logicn-governed-inference-tower.md:242`
- `docs/Knowledge-Bases/logicn-governed-inference-tower.md:243`

Conclusion: use `logicn-runtime-status-SOT.md` and implementation evidence as the
...
- `build/graph/LogicN_GRAPH_REPORT.md:8`
- `build/graph/LogicN_GRAPH_REPORT.md:12`
...
not package nodes for `logicn-tower-citizen`, `logicn-ext-bridge-cpp`, or
`logicn-core-sentinel-*`.

Per-package graphs are more current but cover only nine packages:

- `packages-logicn/logicn-tower-citizen/.graph/package-graph.json:2`
- `packages-logicn/logicn-ext-bridge-cpp/.graph/package-graph.json:2`
- `packages-logicn/logicn-core-sentinel-memory/.graph/package-graph.json:2`

The package-graph tool has a boundary allowlist model:

- `packages-logicn/logicn-devtools-package-graph/src/reporter.ts:55`
- `packages-logicn/logicn-devtools-package-graph/src/reporter.ts:79`
- `packages-logicn/logicn-devtools-package-graph/src/reporter.ts:82`
...
- `packages-logicn/logicn-tower-citizen/src/tpl-simulator.ts:60`
- `packages-logicn/logicn-tower-citizen/src/tpl-simulator.ts:229`
...
1. `scale` is a JavaScript `number`, so non-integer scale values would use
   ...
   Evidence: `packages-logicn/logicn-tower-citizen/src/tpl-simulator.ts:126`,
   `packages-logicn/logicn-tower-citizen/src/tpl-simulator.ts:238`

2. The hybrid router intentionally routes sensitive ops to `fp8`/`fp16` and
   Blackwell paths to `fp4_block`.
   Evidence: `packages-logicn/logicn-tower-citizen/src/precision-strategy.ts:139`,
   `packages-logicn/logicn-tower-citizen/src/precision-strategy.ts:151`,
   `packages-logicn/logicn-tower-citizen/src/precision-strategy.ts:165`

3. The wider compiler/runtime supports Float32/Float64 tensors and parseFloat
   in multiple code paths.
   Evidence: `packages-logicn/logicn-core-compiler/src/lowering-plan.ts:35`,
   `packages-logicn/logicn-core-compiler/src/interpreter.ts:434`,
   `packages-logicn/logicn-core-compiler/src/wat-emitter.ts:1639`
...
- Tower audit logger: `packages-logicn/logicn-tower-citizen/src/audit-logger.ts:10`
- Sentinel Egress: `packages-logicn/logicn-core-sentinel-egress/src/audit-egress.ts:2`
- Sentinel State: `packages-logicn/logicn-core-sentinel-state/src/atomic-writer.ts:12`
...
- `packages-logicn/logicn-tower-citizen/src/audit-logger.ts:120`
- `packages-logicn/logicn-tower-citizen/src/audit-logger.ts:130`
...
- `examples/ai-inference/classifyMessage.lln:64`
- `examples/auth-service/manifestVerificationService.lln:28`
- `examples/auth-service/verifyPassword.lln:40`
...
- `packages-logicn/logicn-tower-citizen/src/audit-logger.ts:89`
- `packages-logicn/logicn-tower-citizen/src/audit-logger.ts:107`
...
- `packages-logicn/logicn-tower-citizen/src/audit-logger.ts:117`
- `packages-logicn/logicn-core-sentinel-egress/src/audit-egress.ts:105`
- `packages-logicn/logicn-core-sentinel-egress/src/audit-egress.ts:112`
...
Evidence:
- `packages-logicn/logicn-core-sentinel-power/ARCHITECTURE_ISSUES.md:9`
- `packages-logicn/logicn-core-sentinel-power/ARCHITECTURE_ISSUES.md:20`
...
Evidence:
- `packages-logicn/logicn-core-sentinel-state/src/atomic-writer.ts:4`
- `packages-logicn/logicn-core-sentinel-state/src/atomic-writer.ts:42`
- `packages-logicn/logicn-core-sentinel-state/src/atomic-writer.ts:57`
...
- `Date.now()` in engine and audit IDs:
  `packages-logicn/logicn-tower-citizen/src/hybrid-engine.ts:225`,
  `packages-logicn/logicn-tower-citizen/src/audit-logger.ts:104`
- per-operation allocation and synthetic demo op creation:
  `packages-logicn/logicn-tower-citizen/src/hybrid-engine.ts:143`
- `new TPLSimulator()` and decode/reload per bridge call:
  `packages-logicn/logicn-tower-citizen/src/bridge/stub-provider.ts:51`,
  `packages-logicn/logicn-tower-citizen/src/bridge/stub-provider.ts:52`
- free-list search in LSM allocation:
  `packages-logicn/logicn-core-sentinel-memory/src/static-memory-pool.ts:130`
- filesystem appends in audit and egress:
  `packages-logicn/logicn-tower-citizen/src/audit-logger.ts:120`,
  `packages-logicn/logicn-core-sentinel-egress/src/audit-egress.ts:136`
- external process probing for GPU detection:
  `packages-logicn/logicn-ext-bridge-cpp/src/hardware-detect.ts:47`
...
Current LogicN is a strong high-assurance prototype with excellent test coverage
