...
The policy declares purpose ppointment_reminder but the flow uses Template.marketingOffer. The policy engine detects this contradiction and raises LLN-GOV-XXX.
