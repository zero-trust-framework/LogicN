...
[ ] Implement effect declaration validation (FUNGI-EFFECT-001, FUNGI-E4001)
[ ] Implement effect propagation validation (FUNGI-EFFECT-002, FUNGI-E4002)
[ ] Implement compile-time effect restrictions (FUNGI-EFFECT-003, FUNGI-E4003)
[ ] Define boundary checker contract (module/package/trust/runtime boundaries)
[ ] Implement module visibility boundary enforcement (FUNGI-BOUNDARY-004, FUNGI-E3004)
[ ] Implement package contract boundary enforcement (FUNGI-BOUNDARY-002)
[ ] Implement compile-time/runtime boundary enforcement (FUNGI-BOUNDARY-003, FUNGI-E4004)
[ ] Implement package trust boundary enforcement (FUNGI-BOUNDARY-005, FUNGI-E4006)
[ ] Implement secret/data leakage boundary detection (FUNGI-BOUNDARY-006)
[ ] Implement network boundary checks — host allowlist (FUNGI-BOUNDARY-008)
[ ] Implement filesystem boundary checks — path allowlist (FUNGI-BOUNDARY-009)
[ ] Implement capability boundary enforcement (FUNGI-BOUNDARY-007, FUNGI-E4005)
...
[ ] Implement manifest hash generation (FUNGI-MANIFEST-002)
[ ] Implement manifest schema validation (FUNGI-MANIFEST-001, FUNGI-MANIFEST-003)
[ ] Implement capability reference validation in manifest (FUNGI-MANIFEST-004)
[ ] Implement runtime target validation in manifest (FUNGI-MANIFEST-005)
...
[ ] Implement FUNGI-EFFECT-001 (undeclared), FUNGI-EFFECT-002 (forbidden), FUNGI-EFFECT-003 (missing capability), FUNGI-EFFECT-004 (unsafe transitive)
...
[ ] Implement FUNGI-BOUNDARY-001 (missing validation), FUNGI-BOUNDARY-002 (missing replay), FUNGI-BOUNDARY-003 (unsafe effect crossing), FUNGI-BOUNDARY-004 (secret leak)
...
[ ] Parse at least 20 v1 .fungi examples
