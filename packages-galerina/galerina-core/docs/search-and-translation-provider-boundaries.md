...
boot.fungi
main.fungi
search-provider-example.fungi
translation-provider-example.fungi
provider-policy.fungi
```
...
```json
{
  "packageReport": {
    ...
    "source": "src/search/search-provider-example.fungi:4",
    "effects": ["network.outbound", "compute.run"],
...
```json
{
  "translationReport": {
    ...
    "source": "src/translation/translation-provider-example.fungi:4",
    "effects": ["network.outbound"],
...
- The project controls enabled languages in boot.fungi.
